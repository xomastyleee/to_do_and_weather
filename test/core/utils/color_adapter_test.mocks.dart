...
// in to_do_and_weather/test/core/utils/color_adapter_test.dart.
...
class MockBinaryWriter extends _i2.Mock implements _i3.BinaryWriter {
  ...
  void writeString(
    ...
    _i4.Converter<String, List<int>>? encoder = const _i4.Utf8Encoder(),
  }) =>
      super.noSuchMethod(
        Invocation.method(
          #writeString,
...
class MockBinaryReader extends _i2.Mock implements _i3.BinaryReader {
  ...
  String readString([
    int? byteCount,
    _i4.Converter<List<int>, String>? decoder = const _i4.Utf8Decoder(),
  ]) =>
      (super.noSuchMethod(
        Invocation.method(
          #readString,
