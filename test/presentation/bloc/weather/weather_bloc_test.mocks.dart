...
// in to_do_and_weather/test/presentation/bloc/weather/weather_bloc_test.dart.
...
import 'package:to_do_and_weather/domain/entities/weather.dart' as _i2;
import 'package:to_do_and_weather/domain/usecases/weather_usecases.dart' as _i3;
...
class MockGetCurrentWeatherUseCase extends _i1.Mock
  ...
  @override
  _i4.Future<_i2.Weather> call(String? city) => (super.noSuchMethod(
        Invocation.method(
          #call,
          [city],
        ),
